...
const validRegexPassword =
  /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[^\w\s]).{8,}/;

//валидация поля email сразу, при изменении
...
function validatePassword() {
  ...
  if (!isValidPassword) {
    errorMessagePassword.textContent =
      "*Пароль введен неверно,должно быть не менее 8 символов и содержать как минимум одну заглавную букву, одну строчную букву, один символ и одну цифру";
...
//   // Additional validation for agreement field
...
agreementForm.addEventListener("click", (event) => {
